//! # `ferroid-tonic`: Shared Types and Protobuf Bindings
//!
...
//! ## Protobuf Usage
//!
//! The [`common::ferroid`] module contains the gRPC interface generated by
//! [`tonic::include_proto!`] and the precompiled [`FILE_DESCRIPTOR_SET`] used
//! for reflection support.
//!
//! ```rust
//! use ferroid_tonic::common::ferroid::id_generator_client::IdGeneratorClient;
//! ```
//!
...
//!
//! [`FILE_DESCRIPTOR_SET`]: crate::common::ferroid::FILE_DESCRIPTOR_SET
