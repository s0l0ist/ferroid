use crate::{
    Id, IdGenStatus, MonotonicClock, Snowflake, SnowflakeTwitterId, TimeSource, ToU64,
    generator::{
...
mod tests {
    use super::*;
    use crate::{BasicUlidGenerator, RandSource, ThreadRandom, ULID, Ulid, UlidGenerator};
    ...
    fn basic_ulid_generator_timestamp_test() {
        ...
        let generator: BasicUlidGenerator<ULID, _, _> =
            BasicUlidGenerator::new(mock_time, mock_rng);
    ...
    fn basic_ulid_generator_random_component_test() {
        ...
        let generator: BasicUlidGenerator<ULID, _, _> =
            BasicUlidGenerator::new(mock_time, counter_rng);
    ...
    fn basic_ulid_generator_deterministic_test() {
        ...
        let generator1: BasicUlidGenerator<ULID, _, _> =
            BasicUlidGenerator::new(mock_time1, mock_rng1);

        let mock_time2 = MockTime { millis: 42 };
        let mock_rng2 = CounterRng::new();
        let generator2: BasicUlidGenerator<ULID, _, _> =
            BasicUlidGenerator::new(mock_time2, mock_rng2);
